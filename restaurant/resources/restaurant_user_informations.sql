...
CREATE TABLE `user_informations` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKodc01glbhg990xd4eq91ati4f` (`user_manager_id`),
  CONSTRAINT `FKodc01glbhg990xd4eq91ati4f` FOREIGN KEY (`user_manager_id`) REFERENCES `user_managers` (`id`)
...
-- Dump completed on 2018-11-24 23:20:07
